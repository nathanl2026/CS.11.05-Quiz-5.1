public class Main {
    ...
    /**
     * Given two arrays of integers, write a method called combine that combines the
     * two arrays into one larger array.
    ...
    public static int[] combine(int[] array1, int[] array2) {
        ...
        for (int i = 0; i < array2.length; i++) {
            myArray[array1.length + i] = array2[i];
        }
        return myArray;
    }

    /**
     * Given two arrays of integers of equal length, write a method called zip that
     * zips together all elements in each array into one larger array.
    ...
    public static int[] zip(int[] array1, int[] array2) {
        ...
        for (int i = 0; i < length; i++) {
            if (i%2==0) {
                myArray[i] = array1[count];
                count++;
            }
            else {
                myArray[i] = array2[count2];
                count2++;
            }
        }
        return myArray;
     ...
     * that multiplies each element in the first array by the element at the corresponding
    ...
    /**
     * Given an array of Strings, write a method called capitalCount that calculates
     * the number of capital letters in each String and stores them into an array.
     ...
     * One of these methods (countCapitalLetters) will be a helper method and will perform the task
     * of counting and returning how many capital letters are in a single word.
     * In other words, the method capitalCount will call (or use) the method countCapitalLetters
     * in order to achieve the desired output.
     * Hint: You can use the statement Character.isAlphabetic( … ) to determine whether a
